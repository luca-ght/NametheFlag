              ...
              {countries.map((country, key) => (
                  ...
                  {key % 3 === 0 && (
                      <div className="row atlas-row" key={key}>
                          ...
                          {countries[key+1] && <div className='aimg' onClick={() => setCurrentCountry(countries[key+1])}>
                          ...
                          {countries[key+2] && <div className='aimg' onClick={() => setCurrentCountry(countries[key+2])}>
