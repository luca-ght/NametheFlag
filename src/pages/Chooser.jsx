            ...
            <div className={"container ch" + (region ? " regions" : "")}>
                ...
                {region && <>
                    <div className="row">
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("austria")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("switzerland")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                    ...
                    <div className="row">
                        <HoverButton text={mode === "shapes" ? "No Data" : t("spain")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("italy")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("france")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                    ...
                    <div className="row">
                        <HoverButton text={t("usa")}
                                     ...
                                     onClick={() => switchC("usa")} />
                        <HoverButton text={mode === "shapes" || mode === "flag" ? "No Data" : t("uk")} icon={mode === "shapes" || mode === "flag" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes" || mode === "flag"}
                        ...
                        <HoverButton text={mode === "shapes" || mode === "flag" ? "No Data" : t("turkey")} icon={mode === "shapes" || mode === "flag" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes" || mode === "flag"}
                    ...
                    <div className="row">
                        <HoverButton text={mode === "shapes" ? "No Data" : t("portugal")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("netherlands")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("belgium")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                    ...
                    <div className="row">
                        <HoverButton text={mode === "shapes" || mode === "flag" ? "No Data" : t("russia")} icon={mode === "shapes" || mode === "flag" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes" || mode === "flag"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("poland")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("czechia")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <div className="row">
                        <HoverButton text={mode === "shapes" || mode === "flag" ? "No Data" : t("china")} icon={mode === "shapes" || mode === "flag" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes" || mode === "flag"}
                         ...
                         <HoverButton text={mode === "shapes" || mode === "flag" ? "No Data" : t("japan")} icon={mode === "shapes" || mode === "flag" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes" || mode === "flag"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("south korea")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                    ...
                    <div className="row">
                        <HoverButton text={mode === "shapes" ? "No Data" : t("canada")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("australia")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" || mode === "flag" ? "No Data" : t("new zealand")} icon={mode === "shapes" || mode === "flag" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes" || mode === "flag"}
                    ...
                    <div className="row">
                        <HoverButton text={mode === "shapes" ? "No Data" : t("estonia")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("latvia")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("lithuania")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                    ...
                    <div className="row">
                        <HoverButton text={mode === "shapes" ? "No Data" : t("nigeria")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("ethiopia")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
                        ...
                        <HoverButton text={mode === "shapes" ? "No Data" : t("southafrica")} icon={mode === "shapes" ? faPersonDigging : faGlobe} comingSoon={mode === "shapes"}
